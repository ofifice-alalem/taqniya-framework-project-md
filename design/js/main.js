        ...
        // ================= INTERACTIVE TABS SYSTEM SWITCHER =================
        function switchTab(containerId, paneId, btn) {
            const container = document.getElementById(containerId);
            if (!container) return;

            // Find all trigger buttons inside the associated navigation bar
            ...
            // Hide all tab panes in this tabs container
            container.querySelectorAll('.bx-tab-pane').forEach(pane => {
                pane.classList.remove('active');
            });

            // Show and animate active pane
