...
> 🔒 **صلاحية الكتابة المقيدة (Scoped Write Authority Invariant):**  
> يملك الـ AI Agent صلاحية كتابة محصورة بدقة على `PROJECT/MD/stack.yaml` **تقتصر حصرياً على إضافة وتثبيت قسم `architecture.communication`** عندما يكون غير محدد في الملف بناءً على اختيار المطور الصريح.  
> 🛑 **يُحظر منعاً باتاً تعديل، استبدال، أو إعادة كتابة أي تقنيات معلنة أخرى** (مثل Backend, Frontend, Database, Testing, Build, Deployment)؛ فاختيار التقنيات قرار سيادي للمطور لا يملكه الـ AI.
